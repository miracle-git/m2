...
Object.keys(components).forEach(function(key) {
  externals[`m2-mobui/packages/${key}`] = `m2-mobui/lib/${key}`
})
externals['m2-mobui/src/locale'] = 'm2-mobui/lib/locale'
externals['m2-mobui/src/mixins'] = 'm2-mobui/lib/mixins'
utilsList.forEach(function(file) {
  file = path.basename(file, '.js')
  externals[`m2-mobui/src/utils/${file}`] = `m2-mobui/lib/utils/${file}`
})
configList.forEach(function(file) {
  file = path.basename(file, '.js')
  externals[`m2-mobui/src/config/${file}`] = `m2-mobui/lib/config/${file}`
})
